  ...
  return (
    <div className="p-4 md:p-6 lg:p-8">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-slate-900">Search Candidates</h1>
      ...
      <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-6 text-center">
        ...
        <p className="mt-2 text-sm text-amber-800">The Candidate Database is currently under development and will be available in Phase 2.</p>
